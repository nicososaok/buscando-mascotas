...
const state = {
    ...
    async updateProfilePassword(credentials) {
        const cs = this.getState();
        try {
    ...
    async updatePetReport(petId, petData) {
        const cs = this.getState();
        try {
    ...
    async sendPetAvistaje(avistajeData) {
        try {
