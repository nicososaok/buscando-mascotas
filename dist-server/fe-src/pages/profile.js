...
export function initProfile() {
   ...
   `;
    const dataForm = pageEl.querySelector("#profile-data-form");
    ...
    dataForm?.addEventListener("submit", async (e) => {
        e.preventDefault();
        const inputName = pageEl.querySelector("#user-name-input").value;
        const submitBtn = dataForm.querySelector(".btn-submit-name");
