...
export function initReportPage() {
   ...
   const form = pageEl.querySelector("#report-form") as HTMLFormElement;
   const dropzone = pageEl.querySelector("#dropzone") as HTMLElement;
   const fileInput = pageEl.querySelector("#file-input") as HTMLInputElement;
   const dropzoneContent = pageEl.querySelector("#dropzone-content") as HTMLElement;
   const btnCancel = pageEl.querySelector("#btn-cancel");

   setTimeout(() => {
      const mapDiv = pageEl.querySelector("#map-container") as HTMLElement;
      if (!mapDiv) return;
   ...
   if (isEditMode) {
      const foundBtn = pageEl.querySelector("#btn-mark-found") as HTMLButtonElement;
