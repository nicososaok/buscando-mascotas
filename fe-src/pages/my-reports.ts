...
export function initMyReportsPage() {
   ...
   const cardsContainer = pageEl.querySelector("#pet-cards-container") as HTMLElement;
   const loadingMessage = pageEl.querySelector("#loading-message") as HTMLElement;
   ...
   state.getMyReportedPets().then((pets) => {
      ...
      pets.forEach((pet: any) => {
         const cardEl = document.createElement("pet-card-comp") as any;
         ...
         cardEl.addEventListener("edit-pet", (e: CustomEvent) => {
         ...
         cardEl.addEventListener("delete-pet", async (e: CustomEvent) => {
